...
Patch2: glibc-xdr-ypall.patch
Patch3: glibc-_NSIG-compat.patch
Patch4: glibc-lt-unblock-cancel.patch
Patch5: glibc-proc-path.patch
Patch6: glibc-cancel-twice.patch
Patch7: glibc-misc.patch
Patch8: glibc-getgrouplist.patch
Patch9: glibc-nscd-lockup.patch
Patch10: glibc-ua-collation.patch
Patch11: glibc-perror.patch
Patch12: glibc-ldconfig-whitespace.patch
Patch13: glibc-strxfrm.patch
Patch14: glibc-localedef-time.patch
Patch15: glibc-getifaddrs.patch
Patch16: glibc-getaddrinfo.patch
Patch17: glibc-libio-compat.patch
Patch18: glibc-cxa-finalize.patch
Patch19: glibc-sprintf.patch
Patch20: glibc-seteuid.patch
Patch21: glibc-ldconfig-order.patch
Patch22: glibc-i686-i386-upgrade.patch
Patch23: glibc-errno-stderr.patch
Patch24: glibc-i386-sysdep-cancel.patch
Patch25: glibc-_res1.patch
Patch26: glibc-_res2.patch
Patch27: glibc-nptl-check.patch
Patch28: glibc-important-hwcaps.patch
Patch29: glibc-dlopen-exec.patch
Patch30: glibc-glob-lnk.patch
Patch31: glibc-glob-brace-escape.patch
Patch32: glibc-reverse-ipv6.patch
Patch33: glibc-sprof.patch
Patch34: glibc-locale-be64.patch
Patch35: glibc-pthread-cond-timedwait.patch
Patch36: glibc-tls-backport.patch
Patch37: glibc-build-hack.patch
Patch38: glibc-nptl-mutex-revamp.patch
Patch39: glibc-nptl-fork-lock.patch
Patch40: glibc-ifaddrs.patch
Patch41: glibc-lt-sigaction.patch
Patch42: glibc-stdio-compat.patch
Patch43: glibc-uselocale.patch
Patch44: glibc-ftw.patch
...
%changelog
* Wed Nov  5 2003 Jakub Jelinek <jakub@redhat.com> 2.3.2-27.9.6
- fix ftw fd leak

* Tue Nov  4 2003 Jakub Jelinek <jakub@redhat.com> 2.3.2-27.9.5
...
* Fri Oct 31 2003 Jakub Jelinek <jakub@redhat.com> 2.3.2-27.9.4
- backport NPTL fork locking changes (#90036)

* Thu Oct 30 2003 Jakub Jelinek <jakub@redhat.com> 2.3.2-27.9.3
- backport NPTL mutex revamp changes (on IA-32 only; see
  http://people.redhat.com/drepper/futex.pdf for details)

* Wed Oct 29 2003 Jakub Jelinek <jakub@redhat.com> 2.3.2-27.9.2
- fix sprof (#103727)
...
* Wed Oct  8 2003 Jakub Jelinek <jakub@redhat.com> 2.3.2-27.9.1
...
- readd _res@GLIBC_2.0 to TLS libc.so - __res_state () was not
...
- use NPTL libs on i686 if either AT_SYSINFO is present (stock RHL9
  ...
  kernel is 2.5.69+ or if set_tid_address (NULL) works (e.g. RHEL3 kernels)
...
* Mon Apr  7 2003 Jakub Jelinek <jakub@redhat.com> 2.3.2-27.9
- fix NPTL pthread_detach and already terminated, but not yet
  joined thread (#88219)
- fix bug-regex4 testcase (#88118)

* Mon Apr  7 2003 Jakub Jelinek <jakub@redhat.com> 2.3.2-26.9
...
* Sat Apr  5 2003 Jakub Jelinek <jakub@redhat.com> 2.3.2-25.9
- fix /usr/lib/nptl/librt.so symlink

* Fri Apr  4 2003 Jakub Jelinek <jakub@redhat.com> 2.3.2-24.9
- avoid running NPTL cleanups twice in some cases

* Thu Apr  3 2003 Jakub Jelinek <jakub@redhat.com> 2.3.2-23.9
...
* Wed Apr  2 2003 Jakub Jelinek <jakub@redhat.com> 2.3.2-22.9
- rebuilt as RHL 9 errata
